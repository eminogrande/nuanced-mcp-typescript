...
- Add a quantized multilingual embedding index and reciprocal-rank fusion with lexical search; normal search remains fail-open when Ollama is unavailable.
